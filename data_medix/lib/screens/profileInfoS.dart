                              ...
                              children: [
                                Expanded(
                                  child: _buildProfileField(
                                      'First Name', 'First Name', userData),
                                ),
                                const SizedBox(width: 8),
                                Expanded(
                                  child: _buildProfileField(
                                      'Last Name', 'Last Name', userData),
                                ),
                              ],
                            )
                          : Column(
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: _isEditMode
                          ? (String? newValue) {
                              setState(() {
                                ref.read(fetchF).updateUserdata('Profession',
                                    newValue ?? userData["profession"]);
                              });
                            }
                          : null,
                    ),
                  ...
                  Padding(
                    ...
                    child: DropdownButtonFormField<String>(
                      ...
                      onChanged: _isEditMode
                          ? (String? newValue) {
                              setState(() {
                                ref.read(fetchF).updateUserdata('Specialty',
                                    newValue ?? userData["Specialty"]);
                              });
                            }
                          : null,
                    ),
